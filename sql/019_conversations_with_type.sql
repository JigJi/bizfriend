-- ============================================
-- RPC: get_my_conversations — add last_message_type
-- ============================================
-- เพิ่ม column last_message_type เพื่อให้ client โชว์ "📷 รูปภาพ" ใน
-- conversation list preview แทน URL ดิบเวลา last message เป็นรูป
-- ============================================

-- ต้อง DROP ก่อนเพราะ RETURNS TABLE เปลี่ยน — CREATE OR REPLACE ไม่พอ
...
AS $$
  ...
  last_msgs AS (
    SELECT DISTINCT ON (conversation_id)
      conversation_id, content, type, created_at, sender_id
    FROM messages
